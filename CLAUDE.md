...
| `coloring.html` | Coloring Fun | Tap-to-fill animal coloring sheets with a color palette, colorable background, and name input (cat/fish/butterfly/owl/turtle/ladybug/dog/frog/chick/bee/pig/snail) |
